...
export function AsideInfo() {
  return (
    <div className="sticky top-[88px] grid w-full grid-cols-2 gap-y-2 rounded-lg bg-accent px-6 py-5">
      ...
      <p className="col-span-2 text-sm text-foreground/80 ">
        ...
        zawhna hrang hrangte Bible atanga chhanna hmangin Lalpa Isua Krista ram
        tihzauh a tum a ni.
      </p>
